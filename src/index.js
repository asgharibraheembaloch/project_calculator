...
function calculator() {
    return __awaiter(this, void 0, void 0, function () {
        var count, totals, values, calc_done, calculation, input, confirmed;
                ...
                case 4:
                    ...
                    if (confirmed['(y/N)']) {
                        switch (calculation.type) {
                            case 'add':
                                totals = values.reduce(function (total, val) { return total + val; });
                                break;
                            case 'subtract':
                                totals = values.reduce(function (total, val) { return total - val; });
                                break;
